...
/**
 * Injects retargeting pixels (TikTok + Meta) on the public shop page.
 * Each shop owner configures their own pixel IDs in settings — we render
 * nothing when neither is set, so untracked shops pay no JS cost.
 */
