...
// Brand icons — installed lucide-react no longer ships brand glyphs, so we
// inline the minimal SVG paths. currentColor lets the parent control the tint.
...
function Icon({ name, className }: { name: string; className?: string }) {
  const C = ICONS[name] ?? ICONS.custom;
